                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        <div class="ml-3">
                            ...
                            <!-- <a href="/logout" class="<?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" >Log Out</a> -->
                        </div>
                    <?php endif; ?>
                </div>
            </div>
